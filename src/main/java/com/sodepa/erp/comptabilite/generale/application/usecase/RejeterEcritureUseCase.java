...
/**
 * UseCase pour rejeter une écriture soumise.
 */
@Service
@RequiredArgsConstructor
public class RejeterEcritureUseCase implements UseCase<UUID, EcritureOutput> {
    ...
    public EcritureOutput execute(UUID input) {
        return adapter.rejeterEcriture(input);
    }
}
